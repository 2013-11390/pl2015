...
Proof.
  ...
  reflexivity.
  right.
  induction a; induction a0; eauto;
  ...
  try (solve by inversion); try (inversion H4; inversion H10; eauto).
  right.
  induction b; eauto; destruct IHb; destruct H; inversion H; induction H; eauto.
  right.
  induction IHb1; induction IHb2.
  destruct H; destruct H0; rewrite H; rewrite H0; eauto.
  destruct H; try (rewrite H; eauto).
  inversion H0.
  eauto.
  destruct H0.
  inversion H.
